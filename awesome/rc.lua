...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "F6", function() awful.util.spawn("steam") end,
              {description = "Open Steam", group = "Games"}), 

    -- Screen Printing
    awful.key({ }, "Print", function() awful.util.spawn("flameshot gui") end,
              {description = "Capture screen (selection)", group = "Screen Capture"}),

    awful.key({ modkey }, "Print", function() awful.util.spawn("flameshot screen") end,
              {description = "Capture screen (full screen)", group = "Screen Capture"})
)
